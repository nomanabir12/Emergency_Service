...
public class Blood_bank extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressHUD = KProgressHUD.create(Blood_bank.this);
        //animation
        ...
        getDataAdapter1=new Blood_adapter(getList);
        firebaseFirestore=FirebaseFirestore.getInstance();
        documentReference=firebaseFirestore.collection("Blood_Bank").document();
    ...
    private void reciveData() {
        progress_check();
        firebaseFirestore.collection("Blood_Bank").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
