...
import com.example.emargenyservice.model.Wasa_adapter;
...
public class Wasa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressHUD = KProgressHUD.create(Wasa.this);
        //animation
        ...
        getDataAdapter1=new Wasa_adapter(getList);
        firebaseFirestore=FirebaseFirestore.getInstance();
        documentReference=firebaseFirestore.collection("Wasa").document();
    ...
    private void reciveData() {
        progress_check();
        firebaseFirestore.collection("Wasa").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
