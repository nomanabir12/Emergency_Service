...
public class Dpdc_Adapter extends RecyclerView.Adapter<Dpdc_Adapter.myview> {
    private List<Service_model> data;

    public Dpdc_Adapter(List<Service_model> data) {
        this.data = data;
    }
    ...
    public myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.dpdc_layout,parent,false);
        return new Dpdc_Adapter.myview(view);
    }
