...
public class Consumer_Adapter extends RecyclerView.Adapter<Consumer_Adapter.myview> {

    private List<Service_model> data;

    public Consumer_Adapter(List<Service_model> data) {
        this.data = data;
    }
    ...
    public myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.consumer,parent,false);
        return new Consumer_Adapter.myview(view);
    }
