...
public class Child_adapter extends RecyclerView.Adapter<Child_adapter.myview> {
    private List<Service_model> data;

    public Child_adapter(List<Service_model> data) {
        this.data = data;
    }
    ...
    public myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new Child_adapter.myview(view);
    }
