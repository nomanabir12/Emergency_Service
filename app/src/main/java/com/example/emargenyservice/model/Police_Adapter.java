...
public class Police_Adapter extends RecyclerView.Adapter<Police_Adapter.myview> {
    private List<Service_model> data;

    public Police_Adapter(List<Service_model> data) {
        this.data = data;
    }
    ...
    public myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.police_2,parent,false);
        return new Police_Adapter.myview(view);
    }
