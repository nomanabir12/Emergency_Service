...
public class Covid_Adapter extends RecyclerView.Adapter<Covid_Adapter.myview> {
    private List<Service_model> data;

    public Covid_Adapter(List<Service_model> data) {
        this.data = data;
    }
    ...
    public myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.covid_19,parent,false);
        return new Covid_Adapter.myview(view);
    }
