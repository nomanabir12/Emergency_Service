...
public class Fire_adapter extends RecyclerView.Adapter<Fire_adapter.myview> {
    private List<Service_model> data;

    public Fire_adapter(List<Service_model> data) {
        this.data = data;
    }
    ...
    public myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.fire_layout,parent,false);
        return new Fire_adapter.myview(view);
    }
