...
import com.example.emargenyservice.Blood_bank;
import com.example.emargenyservice.R;
import com.example.emargenyservice.Service_Adapter;

import java.util.List;

public class Blood_adapter extends RecyclerView.Adapter<Blood_adapter.myview> {
    private List<Service_model> data;


    public Blood_adapter(List<Service_model> data) {
        this.data = data;
    }
    ...
    public myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.blood_bank,parent,false);
        return new Blood_adapter.myview(view);
    }
