...
public class Wasa_adapter extends RecyclerView.Adapter<Wasa_adapter.myview> {
    private List<Service_model> data;

    public Wasa_adapter(List<Service_model> data) {
        this.data = data;
    }
    ...
    public myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.wasa,parent,false);
        return new Wasa_adapter.myview(view);
    }
