...
import com.example.emargenyservice.model.Police_Adapter;
...
public class Police_station extends AppCompatActivity {
    ...
    Police_Adapter getDataAdapter1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressHUD = KProgressHUD.create(Police_station.this);
        //animation
        ...
        getDataAdapter1=new Police_Adapter(getList);
        firebaseFirestore=FirebaseFirestore.getInstance();
        documentReference=firebaseFirestore.collection("Police_Station").document();
    ...
    private void reciveData() {
        progress_check();
        firebaseFirestore.collection("Police_Station").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
