...
public class Ambulance extends AppCompatActivity {
    ...
    Service_Adapter getDataAdapter1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressHUD = KProgressHUD.create(Ambulance.this);
        //animation
        ...
        getDataAdapter1=new Service_Adapter(getList);
        firebaseFirestore=FirebaseFirestore.getInstance();
        documentReference=firebaseFirestore.collection("Ambulance").document();
    ...
    private void reciveData() {
        progress_check();
        firebaseFirestore.collection("Ambulance").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
